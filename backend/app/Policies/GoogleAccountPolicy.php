...
class GoogleAccountPolicy
{
     ...
     */
    public function view(User $user, GoogleAccount $account): bool
    {
     ...
     */
    public function update(User $user, GoogleAccount $account): bool
    {
        return $this->belongsToUser($user, $account);
    }
     ...
     */
    public function delete(User $user, GoogleAccount $account): bool
    {
        return $this->belongsToUser($user, $account);
    }
     ...
     */
    private function belongsToUser(User $user, GoogleAccount $account): bool
    {
