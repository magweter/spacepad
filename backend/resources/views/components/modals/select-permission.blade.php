...
<div
    ...
    x-show="show"
    x-cloak
    @open-permission-modal.window="if ($event.detail.provider === provider) { show = true; permissionType = 'read'; }"
            ...
            >
                <div>
                    <div class="mt-3 text-center sm:mt-5">
                        ...
                        <p class="mt-2 text-sm text-gray-700">Choose the level of access you want to grant to your {{ ucfirst($provider) }} account.</p>
                    </div>
                    
                    <form 
                        x-ref="permissionForm"
                    ...
                    >
                        ...
                        <div class="space-y-4">
                            ...
                            <label class="relative flex cursor-pointer rounded-lg border p-4 shadow-sm focus:outline-none transition-all" 
                                ...
                                <input type="radio" name="permission_type" value="read" class="sr-only" x-model="permissionType">
                                <span class="flex flex-1">
                                    <span class="flex flex-col">
                                        <span class="block text-sm font-medium" :class="permissionType === 'read' ? 'text-blue-900' : 'text-gray-900">Read Only</span>
                                        <span class="mt-1 text-sm" :class="permissionType === 'read' ? 'text-blue-700' : 'text-gray-500'">
                                            View calendar events and room availability. Cannot create or modify events.<br><br>
                                            <strong class="font-semibold" :class="permissionType === 'read' ? 'text-blue-900' : 'text-gray-900'">When you choose for read only, ad-hoc room bookings will not appear in your calendar.</strong>
                                        </span>
                                    </span>
                                </span>
                            ...
                            <label class="relative flex cursor-pointer rounded-lg border p-4 shadow-sm focus:outline-none transition-all" 
                                ...
                                <span class="flex flex-1">
                                    <span class="flex flex-col">
                                        ...
                                        <span class="mt-1 text-sm" :class="permissionType === 'write' ? 'text-blue-700' : 'text-gray-500'">
                                            View calendar events and create new bookings. Allows users to book rooms directly from the tablet display.
                                        </span>
                                    </span>
                                </span>
