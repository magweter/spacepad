                                    ...
                                    <span class="flex flex-col">
                                        ...
                                        <span class="mt-1 text-sm"
                                            ...
                                            <strong class="font-semibold"
                                                ...
                                                you choose for read only, ad-hoc room bookings will not appear in your
                                                calendar.</strong>
                                        </span>
                                    </span>
                                </span>
                                ...
                                <span class="flex flex-1">
                                    <span class="flex flex-col">
                                        <span class="block text-sm font-medium"
                                            ...
                                            Read & Write
                                            <span
                                                class="ml-2 inline-flex items-center rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-600/20">Beta</span>
                                        </span>
                                        <span class="mt-1 text-sm"
                                            :class="permissionType === 'write' ? 'text-blue-700' : 'text-gray-500'">
                                            View calendar events and create new bookings. Allows users to book rooms
                                            directly from the tablet display.
                                        </span>
                                    </span>
                                </span>
                                <svg class="h-5 w-5 flex-shrink-0"
