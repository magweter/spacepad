            ...
            <div class="py-6 sm:px-6">
                ...
                @else
                    ...
                    <div class="flex flex-col space-y-4">
                        @if(config('services.microsoft.enabled'))
                            <a href="{{ route('auth.microsoft.redirect') }}"
                                class="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-3 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent">
                    ...
                    @if(! config('settings.is_self_hosted'))
                        <div class="mt-5 text-xs text-center text-gray-400">
                            By registering you also agree to our <a href="https://spacepad.io/terms" target="_blank" rel="noopener noreferrer" class="underline hover:text-gray-600">Terms of Service</a>, <a href="https://spacepad.io/privacy-policy" target="_blank" rel="noopener noreferrer" class="underline hover:text-gray-600">Privacy Policy</a> and <a href="https://spacepad.io/dpa" target="_blank" rel="noopener noreferrer" class="underline hover:text-gray-600">Data Processing Agreement</a>.
                        </div>
                    @else
                        <div class="mt-5 text-xs text-center text-gray-400">
                            By registering you agree to our <a href="https://spacepad.io/terms" target="_blank" rel="noopener noreferrer" class="underline hover:text-gray-600">Terms of Service</a> and <a href="https://spacepad.io/privacy-policy" target="_blank" rel="noopener noreferrer" class="underline hover:text-gray-600">Privacy Policy</a>.
                        </div>
                    @endif
                @endif
            </div>
