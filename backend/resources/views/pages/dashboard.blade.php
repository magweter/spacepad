        ...
        <x-cards.card class="col-span-12 xl:col-span-8">
            ...
            <div class="border-b border-gray-200 mb-6">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    ...
                    @endif
                    @if(auth()->user()->hasProForCurrentWorkspace())
                        <a href="{{ route('profiles.index') }}" id="tab-profiles" class="tab-button border-b-2 border-transparent pb-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap">
